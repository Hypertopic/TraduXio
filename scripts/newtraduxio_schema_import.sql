...
-- Started on 2010-03-20 16:02:52 CET
...
-- Dependencies: 6
-- Name: SCHEMA import; Type: COMMENT; Schema: -; Owner: postgres
--

COMMENT ON SCHEMA import IS 'standard public schema';
...
-- Dependencies: 6
-- Name: genre; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.genre OWNER TO traduxio;

--
-- TOC entry 1496 (class 1259 OID 16698)
-- Dependencies: 1495 6
-- Name: genre_id_seq; Type: SEQUENCE; Schema: import; Owner: traduxio
--
...
ALTER TABLE import.genre_id_seq OWNER TO traduxio;

--
-- TOC entry 1831 (class 0 OID 0)
-- Dependencies: 1496
-- Name: genre_id_seq; Type: SEQUENCE OWNED BY; Schema: import; Owner: traduxio
--
...
-- Name: interpretation; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.interpretation OWNER TO traduxio;

--
-- TOC entry 1498 (class 1259 OID 16709)
-- Dependencies: 6
-- Name: log; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.log OWNER TO traduxio;

--
-- TOC entry 1499 (class 1259 OID 16715)
-- Dependencies: 6 1498
-- Name: log_id_seq; Type: SEQUENCE; Schema: import; Owner: traduxio
--
...
ALTER TABLE import.log_id_seq OWNER TO traduxio;

--
-- TOC entry 1832 (class 0 OID 0)
-- Dependencies: 1499
-- Name: log_id_seq; Type: SEQUENCE OWNED BY; Schema: import; Owner: traduxio
--
...
-- Dependencies: 1791 6
-- Name: privileges; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.privileges OWNER TO traduxio;

--
-- TOC entry 1508 (class 1259 OID 25150)
-- Dependencies: 6 1509
-- Name: privileges_id_seq; Type: SEQUENCE; Schema: import; Owner: traduxio
--
...
ALTER TABLE import.privileges_id_seq OWNER TO traduxio;

--
-- TOC entry 1833 (class 0 OID 0)
-- Dependencies: 1508
-- Name: privileges_id_seq; Type: SEQUENCE OWNED BY; Schema: import; Owner: traduxio
--
...
-- Name: role; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.role OWNER TO traduxio;

--
-- TOC entry 1501 (class 1259 OID 16724)
-- Dependencies: 6 1500
-- Name: role_id_seq; Type: SEQUENCE; Schema: import; Owner: traduxio
--
...
ALTER TABLE import.role_id_seq OWNER TO traduxio;

--
-- TOC entry 1834 (class 0 OID 0)
-- Dependencies: 1501
-- Name: role_id_seq; Type: SEQUENCE OWNED BY; Schema: import; Owner: traduxio
--
...
-- Dependencies: 6
-- Name: taggable; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.taggable OWNER TO traduxio;

--
-- TOC entry 1503 (class 1259 OID 16729)
-- Dependencies: 1502 6
-- Name: taggable_id_seq; Type: SEQUENCE; Schema: import; Owner: traduxio
--
...
ALTER TABLE import.taggable_id_seq OWNER TO traduxio;

--
-- TOC entry 1835 (class 0 OID 0)
-- Dependencies: 1503
-- Name: taggable_id_seq; Type: SEQUENCE OWNED BY; Schema: import; Owner: traduxio
--
...
-- Name: sentence; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.sentence OWNER TO traduxio;

--
-- TOC entry 1505 (class 1259 OID 16737)
-- Dependencies: 1786 6
-- Name: tag; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.tag OWNER TO traduxio;

--
-- TOC entry 1507 (class 1259 OID 16832)
-- Dependencies: 1789 6
-- Name: user; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import."user" OWNER TO traduxio;

--
-- TOC entry 1506 (class 1259 OID 16760)
-- Dependencies: 1787 1788 6 1502
-- Name: work; Type: TABLE; Schema: import; Owner: traduxio; Tablespace: 
--
...
ALTER TABLE import.work OWNER TO traduxio;

--
-- TOC entry 1776 (class 2604 OID 16766)
-- Dependencies: 1496 1495
-- Name: id; Type: DEFAULT; Schema: import; Owner: traduxio
--
...
-- Name: genre_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: interpretation_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: log_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: privileges_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: role_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: sentence_number_key; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: sentence_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: tag_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: taggable_id_key; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Dependencies: 1502 1502
-- Name: taggable_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: user_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: work_pkey; Type: CONSTRAINT; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Dependencies: 1506
-- Name: fki_; Type: INDEX; Schema: import; Owner: traduxio; Tablespace: 
--
...
-- Name: from_sentence; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: interpretation_work_id_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: privileges_work_id_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: sentence_workid_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: tag_genre_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: tag_taggable_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: tag_user_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: to_sentence; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Name: work_creator_fkey; Type: FK CONSTRAINT; Schema: import; Owner: traduxio
--
...
-- Dependencies: 6
-- Name: import; Type: ACL; Schema: -; Owner: postgres
--

REVOKE ALL ON SCHEMA import FROM PUBLIC;
REVOKE ALL ON SCHEMA import FROM postgres;
GRANT ALL ON SCHEMA import TO postgres;
GRANT ALL ON SCHEMA import TO PUBLIC;


-- Completed on 2010-03-20 16:02:56 CET
