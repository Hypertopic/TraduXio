...
Scénario: Je rentre des identifiants corrects du premier coup

Etant donné qu'un utilisateur souhaite s'identifier pour accéder au site TraduXio
Quand il est sur la page d'accueil du site TraduXio, il clique sur l'onglet "Se connecter" et remplit les champs login et mot de passe
...
Etant donné qu'un utilisateur souhaite s'identifier pour accéder au site TraduXio
Quand il est sur la page d'accueil du site TraduXio, il clique sur l'onglet "Se connecter" et remplit les champs login et mot de passe
avec ses identifiants personnels mais ces derniers sont éronnées.
